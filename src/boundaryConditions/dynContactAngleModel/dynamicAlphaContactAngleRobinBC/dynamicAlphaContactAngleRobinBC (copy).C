...
#include "dynamicAlphaContactAngleRobinBC.H"
...
bool Foam::dynamicAlphaContactAngleRobinBC::
hasContactLine
(
    label faceI
) const
...
dynamicAlphaContactAngleRobinBC
(
    const dynamicAlphaContactAngleRobinBC& gcpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::dynamicAlphaContactAngleRobinBC::theta
(
...
void Foam::dynamicAlphaContactAngleRobinBC::write(Ostream& os) const
{
