...
#include "dynamicAlphaContactAngleCoxVoinovFvPatchScalarField.H"
...
bool Foam::dynamicAlphaContactAngleCoxVoinovFvPatchScalarField::
hasContactLine
(
    label faceI
) const
...
Foam::dynamicAlphaContactAngleCoxVoinovFvPatchScalarField::
dynamicAlphaContactAngleCoxVoinovFvPatchScalarField
(
    const fvPatch& p,
...
dynamicAlphaContactAngleCoxVoinovFvPatchScalarField
(
    const dynamicAlphaContactAngleCoxVoinovFvPatchScalarField& gcpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::dynamicAlphaContactAngleCoxVoinovFvPatchScalarField::theta
(
...
) const
{
    ...
    {   
        if (hasContactLine(faceI))
        {
            ...
            thetaf[faceI] = min(180 / constant::mathematical::pi * (pow(beta_ *mag(Ca[faceI]) +
...
void Foam::dynamicAlphaContactAngleCoxVoinovFvPatchScalarField::write(Ostream& os) const
{
